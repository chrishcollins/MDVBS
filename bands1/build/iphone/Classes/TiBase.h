...
// in simulator we redefine to format for bands1 Developer console
...
{\
	NSString * exceptionName = [@"org.bands1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bands1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIbands1NativeItemNone = -1, 
	UIbands1NativeItemSpinner = -2,
	UIbands1NativeItemProgressBar = -3,
	
	UIbands1NativeItemSlider = -4,
	UIbands1NativeItemSwitch = -5,
	UIbands1NativeItemMultiButton = -6,
	UIbands1NativeItemSegmented = -7,
	
	UIbands1NativeItemTextView = -8,
	UIbands1NativeItemTextField = -9,
	UIbands1NativeItemSearchBar = -10,
	
	UIbands1NativeItemPicker = -11,
	UIbands1NativeItemDatePicker = -12,
	
	UIbands1NativeItemInfoLight = -13,
	UIbands1NativeItemInfoDark = -14,
	
	UIbands1NativeItemDisclosure = -15,
	
	UIbands1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all bands1 instances of
