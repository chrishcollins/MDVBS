...
/**
 The base class for all bands1 modules
 */
...
/**
 bands1 Platform calls this method on startup.
 */
-(void)startup;

/**
 bands1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 bands1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 bands1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 bands1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
