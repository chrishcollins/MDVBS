...
/**
 Base class for all Project3AVF views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Project3AVF view hierarchy (such as wrapped iOS UIViews) was touched.
