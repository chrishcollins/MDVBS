...
// in simulator we redefine to format for Project3AVF Developer console
...
{\
	NSString * exceptionName = [@"org.project3avf." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project3avf";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProject3AVFNativeItemNone = -1, 
	UIProject3AVFNativeItemSpinner = -2,
	UIProject3AVFNativeItemProgressBar = -3,
	
	UIProject3AVFNativeItemSlider = -4,
	UIProject3AVFNativeItemSwitch = -5,
	UIProject3AVFNativeItemMultiButton = -6,
	UIProject3AVFNativeItemSegmented = -7,
	
	UIProject3AVFNativeItemTextView = -8,
	UIProject3AVFNativeItemTextField = -9,
	UIProject3AVFNativeItemSearchBar = -10,
	
	UIProject3AVFNativeItemPicker = -11,
	UIProject3AVFNativeItemDatePicker = -12,
	
	UIProject3AVFNativeItemInfoLight = -13,
	UIProject3AVFNativeItemInfoDark = -14,
	
	UIProject3AVFNativeItemDisclosure = -15,
	
	UIProject3AVFNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Project3AVF instances of
