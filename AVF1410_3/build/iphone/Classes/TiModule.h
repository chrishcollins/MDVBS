...
/**
 The base class for all Project3AVF modules
 */
...
/**
 Project3AVF Platform calls this method on startup.
 */
-(void)startup;

/**
 Project3AVF Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Project3AVF Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Project3AVF Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Project3AVF Platform calls this method on resume.
 @param sender The sender of the event.
 */
