...
//@interface Project3AVFObject : NSObject
//@end

@interface Project3AVFObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Project3AVFObject class]])
		{
			for (NSString *key in [[(Project3AVFObject*)o modules] allKeys])
			{
