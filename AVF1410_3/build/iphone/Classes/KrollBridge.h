...
@interface Project3AVFObject : KrollCoverageObject {
#else
@interface Project3AVFObject : KrollObject {
#endif
@private
...
extern NSString * Project3AVF$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Project3AVFObject *_project3avf;
    KrollObject* console;
	BOOL shutdown;
