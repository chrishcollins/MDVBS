...
/**
 Base class for all AVF1410_2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVF1410_2 view hierarchy (such as wrapped iOS UIViews) was touched.
