...
// in simulator we redefine to format for AVF1410_2 Developer console
...
{\
	NSString * exceptionName = [@"org.avf1410_2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf1410_2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF1410_2NativeItemNone = -1, 
	UIAVF1410_2NativeItemSpinner = -2,
	UIAVF1410_2NativeItemProgressBar = -3,
	
	UIAVF1410_2NativeItemSlider = -4,
	UIAVF1410_2NativeItemSwitch = -5,
	UIAVF1410_2NativeItemMultiButton = -6,
	UIAVF1410_2NativeItemSegmented = -7,
	
	UIAVF1410_2NativeItemTextView = -8,
	UIAVF1410_2NativeItemTextField = -9,
	UIAVF1410_2NativeItemSearchBar = -10,
	
	UIAVF1410_2NativeItemPicker = -11,
	UIAVF1410_2NativeItemDatePicker = -12,
	
	UIAVF1410_2NativeItemInfoLight = -13,
	UIAVF1410_2NativeItemInfoDark = -14,
	
	UIAVF1410_2NativeItemDisclosure = -15,
	
	UIAVF1410_2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF1410_2 instances of
