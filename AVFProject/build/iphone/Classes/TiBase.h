...
// in simulator we redefine to format for ImLocal Developer console
...
{\
	NSString * exceptionName = [@"org.imlocal." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.imlocal";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIImLocalNativeItemNone = -1, 
	UIImLocalNativeItemSpinner = -2,
	UIImLocalNativeItemProgressBar = -3,
	
	UIImLocalNativeItemSlider = -4,
	UIImLocalNativeItemSwitch = -5,
	UIImLocalNativeItemMultiButton = -6,
	UIImLocalNativeItemSegmented = -7,
	
	UIImLocalNativeItemTextView = -8,
	UIImLocalNativeItemTextField = -9,
	UIImLocalNativeItemSearchBar = -10,
	
	UIImLocalNativeItemPicker = -11,
	UIImLocalNativeItemDatePicker = -12,
	
	UIImLocalNativeItemInfoLight = -13,
	UIImLocalNativeItemInfoDark = -14,
	
	UIImLocalNativeItemDisclosure = -15,
	
	UIImLocalNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ImLocal instances of
